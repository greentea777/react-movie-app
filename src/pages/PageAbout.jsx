    ...
    <main className="flex-1">
      <section className="max-w-6xl mx-auto mt-16 p-5 text-white">
        ...
        <div className="flex flex-col sm:flex-row gap-8 mt-5">
          <div className="pb-10 border-b-2 border-red-700 sm:pr-5 sm:border-r-2 sm:border-b-0 sm:pb-0 mt-5">
          ...
          <div className="flex flex-col items-center sm:p-0">
            ...
            <h3 className="text-[22px] sm:text-2xl md:text-3xl font-bold uppercase pb-2 mb-3">
            ...
            <ul>
              <li>
                ...
                <a href="https://www.linkedin.com/in/yang-zhijun/">
                  <svg
                    className="inline"
                ...
                <a href="mailto:y_1st.zenith@icloud.com">
                  <svg
                    className="inline"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                ...
                <a href="https://github.com/zy-link">
                  <svg
                    className="inline"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
              ...
              <li>
                ...
                <a href="https://www.linkedin.com/in/willy-hsu-216137267/">
                  <svg
                    className="inline"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                ...
                <a href="mailto:hsu.waiting@gmail.com">
                  <svg
                    className="inline"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                ...
                <a href="https://github.com/greentea777/">
                  <svg
                    className="inline"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
              ...
              <li>
                ...
                <a href="https://www.linkedin.com/in/sally-leung-06a87618b/">
                  <svg
                    className="inline"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                ...
                <a href="mailto:sallyleungg18@gmail.com">
                  <svg
                    className="inline"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                ...
                <a href="https://github.com/sleung204">
                  <svg
                    className="inline"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
